      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center ">
        ...
        <div className="flex flex-col mx-auto space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <a
            ...
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-none focus:ring-4 focus:ring-gray-100"
          >
